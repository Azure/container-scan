...
class GitHubClient {
    ...
    createCheckRunWithFallback(checkRunThroughAppPayload, checkRunPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.statusCode == httpClient_1.StatusCodes.UNPROCESSABLE_ENTITY && response.body && response.body.message && response.body.message.error_code === 'APP_NOT_INSTALLED') {
