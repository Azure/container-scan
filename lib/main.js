...
const { imageName } = require("./inputHelper");
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (trivyStatus === trivyHelper.TRIVY_EXIT_CODE) {
            ...
            throw new Error("An error occurred while scanning container image: " + imageName + " for vulnerabilities. Please check your image name and try again.");
        }
        let dockleStatus;
